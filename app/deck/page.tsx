...
export const metadata: Metadata = {
  title: "Abadi — deck",
  description: "Eleven slides on Abadi: why 2,422 settled markets pointed at market making rather than prediction, and what happened when the vault quoted inside the spread.",
...
export default function Deck() {
  return (
    <>
      ...
      <section className="slide cover" data-i="0" tabIndex={0} aria-label="Slide 1 of 11">
      ...
      <section className="slide" data-i="1" tabIndex={0} aria-label="Slide 2 of 11">
      ...
      <section className="slide" data-i="2" tabIndex={0} aria-label="Slide 3 of 11">
      ...
      <section className="slide" data-i="3" tabIndex={0} aria-label="Slide 4 of 11">
      ...
      <section className="slide" data-i="4" tabIndex={0} aria-label="Slide 5 of 11">
      ...
      <section className="slide" data-i="5" tabIndex={0} aria-label="Slide 6 of 11">
      ...
      <section className="slide" data-i="6" tabIndex={0} aria-label="Slide 7 of 11">
        <div className="two">
          <div>
      ...
      <section className="slide" data-i="7" tabIndex={0} aria-label="Slide 8 of 11">
      ...
      <section className="slide" data-i="9" tabIndex={0} aria-label="Slide 10 of 11">
      ...
      {/* The roadmap slide the design spec called for on day one and the deck never got.
        *
        * It is measured rather than aspirational, because the venue answered the question
        * for us: `Market` rows from the indexer, one day, every tier. The empty book this
      ...
      {/* No inline width. It beat the stylesheet's `width: 100%`, and `show()` then applied
          `scaleX()` on top of it, so the rail was a tenth of a tenth: at the last slide it
          reached 10% of the track and never further. The QA test only ever compared one
          position to the next, so it moved, and passed, and was wrong throughout. */}
      ...
      <div className="deckbar">
        ...
        <span className="count"><b>01</b> / 11</span>
