...
(function () {
  ...
  /* A host that hangs never rejects, so every read on this site goes through one bounded
     fetch. The reasoning, and why it is one function rather than a copy per file, is in
     web/fetchin.js. */
